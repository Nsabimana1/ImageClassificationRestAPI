...
//        Drawing d1 = new Drawing(2, 2);
        FloatDrawing d1 = new FloatDrawing(2, 2);
        d1.set(0, 0, 1.0);
        d1.set(0, 1, 1.0);
        d1.set(1, 0, 0.0);
        d1.set(1, 1, 1.0);
...
//        ArrayList<Duple<String,Drawing>> samples = new ArrayList<>();
        ArrayList<Duple<String,FloatDrawing>> samples = new ArrayList<>();
        samples.add(new Duple<>("A", new FloatDrawing(new double[][]{{1.0, 1.0}, {0.7, 0.4}})));
        samples.add(new Duple<>("B", new FloatDrawing(new double[][]{{1.0, 1.0}, {0.5, 1.0}})));
